...
├── main.py                    # Example pipeline orchestration
...
pythonfrom data_generation import create_example_csv, generate_training_data
...
Then, annotate the training data with sexualization labels. After you have those labels: 

## Train Binary Classifier
Annotate the generated data with labels (0=benign, 1=violating), then train the classifier:
rom classifier import ClassifierConfig, SexualizationClassifier, train_classifier
...
pythonfrom data_augmentation import construct_preference_tuples
...
For supervised fine-tuning instead of DPO:
